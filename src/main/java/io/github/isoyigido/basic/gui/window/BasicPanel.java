...
/// Provides an update method which forwards the update call to {@link GUIManager}.
...
public class BasicPanel extends JPanel {
    ...
    public BasicPanel(int windowWidth, int windowHeight) {
        ...
        // Initialize the mouse and keyboard input listeners
        ...
        addMouseWheelListener(mouseInputListener);
        addKeyListener(keyboardInputListener);

        // Set the panel of the GUI manager to this
        GUIManager.setPanel(this);
    }
    ...
    /// Forwards the update call to {@link GUIManager}.
    public void update() {
        GUIManager.update();
    }
}